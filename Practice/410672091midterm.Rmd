...
```{r ans16}
(hwGrades$學號 %in% classSurvey$學號) -> abc
hwGrades[abc,]-> hwGradeSubsample
```
...
```{r ans19}
classSurvey$學號[classSurvey$課外活動=="團隊活動"] -> A
classSurvey$學號[classSurvey$課外活動=="團隊活動, 學會"] -> B
classSurvey$學號[classSurvey$課外活動=="團隊活動, 打工"] -> C
classSurvey$學號[classSurvey$課外活動=="打工, 團隊活動"] -> D

hwGradeSubsample$有團活 <- hwGradeSubsample$學號 %in% A | hwGradeSubsample$學號 %in% B | hwGradeSubsample$學號 %in% C | hwGradeSubsample$學號 %in% D


hwGradeSubsample$平均成績[(hwGradeSubsample$女性==T & hwGradeSubsample$有團活==T)] -> E
mean(E)->meanE
meanE
...
```{r ans23}
hwSubmit3$截止時差[hwSubmit3$女性==T] -> Female
mean(Female) -> FemaleTime
hwSubmit3$截止時差[hwSubmit3$女性==F] -> Male
mean(Male) -> MaleTime
FemaleTime-MaleTime -> 時差
時差
```
