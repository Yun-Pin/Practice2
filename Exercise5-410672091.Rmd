...
---
作業上傳截止日期：2018-
12-16 00:00:00 Asia/Taipei Time (即台灣時間15號半夜12點，或16號凌晨0點)
...
```{r ans11}
a <- which(transcriptData$學號=='edfeQ7fb8')
subsample <- transcriptData[a,]
subsample
...
```{r ans15}
系別 <- str_sub(transcriptData$"學號",5,6)

cbind(transcriptData,系別)
